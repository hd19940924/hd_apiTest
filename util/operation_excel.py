...
class OperationExcel:
	def __init__(self,file_name=None,sheet_id=None):
		if file_name:
			...
			xlsPath = os.path.join(os.path.dirname(path), "data" ,"userCase.xlsx")
	...
	def get_xls(self, xls_name, sheet_name):  # xls_name填写用例的Excel名称 sheet_name该Excel的sheet名称
		cls = []
		# 获取用例文件路径
		xlsPath = os.path.join(os.path.dirname(path), "data",  xls_name)
...
if __name__ == '__main__':
	...
	data = OperationExcel().get_xls("userCase.xlsx", "login")
	print(data)
	print(data[2])